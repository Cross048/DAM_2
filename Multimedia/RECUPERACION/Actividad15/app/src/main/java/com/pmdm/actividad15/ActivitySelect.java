...
import com.pmdm.actividad15.activitys.Activity1;
import com.pmdm.actividad15.activitys.Activity2;
import com.pmdm.actividad15.activitys.Activity3;
import com.pmdm.actividad15.activitys.Activity4;
import com.pmdm.actividad15.adapters.CustomAdapter1;
import com.pmdm.actividad15.adapters.CustomAdapter2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lista1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                switch (position) {
                    case 0:
                        startActivity(new Intent(ActivitySelect.this, Activity1.class));
                        break;
                    case 1:
                        mostrarLista2(lista1, lista2);
                        break;
                    case 2:
                        startActivity(new Intent(ActivitySelect.this, Activity4.class));
                        break;
                    default:
                        break;
                }
    ...
    private void mostrarLista2(ListView lista1, ListView lista2) {
        ...
        lista2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                switch (position) {
                    case 0:
                        startActivity(new Intent(ActivitySelect.this, Activity2.class));
                        break;
                    case 1:
                        startActivityForResult(new Intent(ActivitySelect.this, Activity3.class), CODIGO_LLAMADA_ACT3);
                        break;
                    default:
                        break;
                }
