...
public class Ejercicio01 {
    ...
    private static final String modificarEmpleado = "SET SQL_SAFE_UPDATES = 0; UPDATE `empleado` SET `Nombre`=?, `Apel1`=?, `Apel2`=?, `Sexo`=?, `Dirección`=?, `Fechanac`=?, `Salario`=?, `Numdept`=?, `NSSsup`=?, `dpto`=? WHERE `NIF`=?";
