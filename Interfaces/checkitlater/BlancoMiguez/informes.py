...
class Informes:
    ...
    def reportclientes():
        ...
        Crea un informe PDF con la lista de clientes, incluyendo código, DNI, razón social,
        municipio, teléfono y fecha de baja si aplica.
        """
        try:
    ...
    def reportdrivers():
        ...
        Crea un informe PDF con la lista de conductores, incluyendo código, apellidos, nombre,
        teléfono, licencias y fecha de baja si aplica.
        """
        try:
            fecha = datetime.today()
            fecha = fecha.strftime('%Y_%m_%d_%H_%M_%S')
    ...
    def encriptarDNI(dni):
        """
        Encripta el DNI ocultando parte de los dígitos.

        :param dni: El DNI a encriptar.
    ...
    def checkboxinforme():
        """
        Muestra un cuadro de diálogo con opciones para seleccionar los informes a generar.
        """
        try:
    ...
    def topFactura(titulo):
        """
        Crea la cabecera de un informe de factura.
    ...
    def reportfactura():
        """
        Genera y muestra un informe de la factura actual.
        """
        try:
